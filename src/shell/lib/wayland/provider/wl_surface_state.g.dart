...
final class WlSurfaceStateProvider
  ...
  Override overrideWithValue(WlSurface value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<WlSurface>(value),
    );
  }
...
final class WlSurfaceStateFamily extends $Family
  ...
  WlSurfaceStateProvider call(SurfaceId surfaceId) =>
...
abstract class _$WlSurfaceState extends $Notifier<WlSurface> {
  ...
  void runBuild() {
    ...
    final ref = this.ref as $Ref<WlSurface, WlSurface>;
    final element =
        ref.element
            as $ClassProviderElement<
              AnyNotifier<WlSurface, WlSurface>,
              WlSurface,
              Object?,
              Object?
            >;
