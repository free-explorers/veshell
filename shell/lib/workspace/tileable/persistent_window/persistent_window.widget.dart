...
import 'package:shell/application/app_icon.dart';
import 'package:shell/wayland/request/close_window/close_window.model.serializable.dart';
import 'package:shell/wayland/request/resize_window/resize_window.model.serializable.dart';
import 'package:shell/wayland/surface/xdg_toplevel/xdg_toplevel_surface.dart';
import 'package:shell/wayland/wayland.manager.dart';
import 'package:shell/window/window.manager.dart';
import 'package:shell/window/window.model.dart';
import 'package:shell/workspace/tileable/persistent_window/window_placeholder.widget.dart';
import 'package:shell/workspace/tileable/tileable.widget.dart';
