...
import 'package:shell/wayland/provider/request/close_window/close_window.model.serializable.dart';
import 'package:shell/wayland/provider/request/resize_window/resize_window.model.serializable.dart';
import 'package:shell/wayland/provider/wayland.manager.dart';
import 'package:shell/wayland/widget/xdg_toplevel_surface.dart';
import 'package:shell/window/model/window.model.dart';
import 'package:shell/window/provider/window.manager.dart';
import 'package:shell/workspace/widget/tileable/persistent_window/window_placeholder.widget.dart';
