...
pub fn pnp_id_to_name(vendor: &[char; 3]) -> Option<&'static str> {
    match vendor {
        ...
        ['A', 'T', 'T'] => Some("AT&T"),
        ['A', 'T', 'U'] => Some("Avocor Technologies USA, Inc"),
        ...
        ['B', 'C', 'K'] => Some("Beck GmbH & Co. Elektronik Bauelemente KG"),
        ['B', 'C', 'M'] => Some("Broadcom"),
        ...
        ['C', 'S', 'T'] => Some("CSTI Inc"),
        ['C', 'S', 'W'] => Some("China Star Optoelectronics Technology Co., Ltd"),
        ...
        ['D', 'X', 'N'] => Some(" Dixon Technologies (India) Limited"),
        ...
        ['E', 'T', 'G'] => Some("Eizo Technologies GmbH"),
        ...
        ['E', 'V', 'P'] => Some("EverPro Technologies Company Limited"),
        ['E', 'V', 'X'] => Some("Everex"),
        ['E', 'X', 'A'] => Some("Exabyte"),
        ...
        ['H', 'N', 'M'] => Some("HONOR Device Co., Ltd."),
        ...
        ['I', 'V', 'O'] => Some("InfoVision Optoelectronics (Kunshan) Co.,Ltd China"),
        ...
        ['J', 'L', 'K'] => Some("UNIONMAN TECHNOLOGY CO., LTD"),
        ...
        ['K', 'G', 'N'] => Some("KOGAN AUSTRALIA PTY LTD"),
        ['K', 'I', 'O'] => Some("Kionix, Inc."),
        ['K', 'I', 'S'] => Some("KiSS Technology A/S"),
        ['K', 'L', 'T'] => Some("Colorlight"),
        ...
        ['L', 'N', 'C'] => Some("Lincoln Technology Solutions"),
        ...
        ['M', 'T', 'T'] => Some("Moore Threads Virtual Display"),
        ...
        ['N', 'C', 'V'] => Some("NewCoSemi (Beijing) Technology CO.,Ltd."),
        ...
        ['O', 'F', 'I'] => Some("Jiangxi Jinghao Optical Co., Ltd."),
        ...
        ['S', 'D', 'C'] => Some("Samsung Display Corp."),
        ...
        ['S', 'G', 'M'] => Some("SAGEM"),
        ['S', 'G', 'N'] => Some("Shenzhen Soogeen Electronics Co., LTD."),
        ...
        ['T', 'M', 'A'] => Some("Tianma Microelectronics Ltd."),
        ...
        ['W', 'M', 'I'] => Some("Weidmuller Interface GmbH & Co. KG"),
